...
declare class YTPlayerView extends UIView implements WKNavigationDelegate {
	...
	static appearanceForTraitCollectionWhenContainedInInstancesOfClasses(trait: UITraitCollection, containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): YTPlayerView; // inherited from UIAppearance

	static appearanceWhenContainedIn(ContainerClass: typeof NSObject): YTPlayerView; // inherited from UIAppearance

	static appearanceWhenContainedInInstancesOfClasses(containerTypes: NSArray<typeof NSObject> | typeof NSObject[]): YTPlayerView; // inherited from UIAppearance
	...
	cuePlaylistByVideosIndexStartSecondsSuggestedQuality(videoIds: NSArray<any> | any[], index: number, startSeconds: number, suggestedQuality: YTPlaybackQuality): void;
	...
	loadPlaylistByVideosIndexStartSecondsSuggestedQuality(videoIds: NSArray<any> | any[], index: number, startSeconds: number, suggestedQuality: YTPlaybackQuality): void;
